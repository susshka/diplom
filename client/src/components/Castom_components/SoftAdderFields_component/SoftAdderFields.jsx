...
const SoftAdderFields = () => {
    const [softData, setSoftData] = useState({soft_name:"", soft_code:"", save_type_logs:"", path_dir:"", server_name:"", databs_name:"", table_name:"", user_name:"", pwd:"", watching:"", default_time_watching:"", active_time_watching:""});
    const {addNewSoft} = useSoft();

    const hendlerSubmit = (event) =>{
        event.preventDefault();
        addNewSoft(softData)
        setSoftData({soft_name:"", soft_code:"", save_type_logs:"", path_dir:"", server_name:"", databs_name:"", table_name:"", user_name:"", pwd:"", watching:"", default_time_watching:"", active_time_watching:""})
    }
